...
class EditGallery extends React.Component {
  ...
  doSave() {
    ...
    const { name, description, dateTaken, type } = content;
      ...
      .then((response) => {
        ...
        this.setState((prevState) => ({
          content: {
            ...
            photos: prevState.content.photos.filter(
              (photo) => photo.pictureId !== pictureId,
            ),
          },
        }));
        return response.json();
  ...
  render() {
    const { galleryId, deleteGallery, deselectGallery } = this.props;
    const { content, saveState, displayLock } = this.state;

    const { description, name, dateTaken, photos, type } = content;
        ...
        <div className="dialogue">
          <div className="edit-stuff">
            ...
            <input
              ...
              value={dateTaken}
              onChange={(e) => {
                this.handleChange("dateTaken", e.target.value);
              }}
            />
            <br />
            <br />
            ...
            <div className="upload-picture-form">
              <h3>
                Add new photos to this gallery by clicking the "Attach" button
                below
              </h3>
              <form
                action="/api/v1/photo/new/"
              ...
              >
                ...
                <label htmlFor="file">
                  Attach Pictures (.png, .jpg or .jpeg)
                </label>
                <br />
                <input
                  type="file"
            ...
            <br />
            <h3>
              <a href={`/gallery/${galleryId}/`} className="logout-button">
                View This Gallery
              </a>
            </h3>
            <br />
