...
class EditUser extends React.Component {
  ...
  render() {
    const { username, logname, deleteUser, cancelEdit } = this.props;
    const { content } = this.state;
    const { pass1, pass2, success } = content;
      ...
      <div className="edit-account">
        ...
        >
          ...
          <input
            ...
            value={success ? "" : pass1}
            onChange={(e) => {
              this.handleChange("pass1", e.target.value);
            }}
          />
          <br />
          <br />
          <label htmlFor="renewpw">Retype New Password</label>
          <br />
          <input
            type="password"
            name="renewpw"
          ...
          <br />
          {success ? (
            <span className="successpass">Password reset successfully!</span>
          ) : pass1 !== pass2 ? (
        ...
        {isOtherAdmin ? (
          <ConfirmatoryButton
            text={"Delete this administrator"}
            args={{ user: username }}
            callback={deleteUser}
          />
        ) : null}
